defmodule Anvil.Accounts.User do
  use Ash.Resource,
    otp_app: :anvil,
    domain: Anvil.Accounts,
  ...
  authentication do
    add_ons do
      ...
      confirmation :confirm_new_user do
        ...
        sender Anvil.Accounts.User.Senders.SendNewUserConfirmationEmail
      end
    end

    tokens do
      enabled? true
      token_resource Anvil.Accounts.Token
      signing_secret Anvil.Secrets
    ...
    strategies do
      password :password do
        ...
        resettable do
          sender Anvil.Accounts.User.Senders.SendPasswordResetEmail
      ...
      magic_link do
        ...
        sender Anvil.Accounts.User.Senders.SendMagicLinkEmail
      end
